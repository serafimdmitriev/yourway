...
public class ViewsDestinationChoose extends CustomViewGroup {
    ...
    public ViewsDestinationChoose() {
        super("DestinationChooseViews");
    ...
    public void specialOpen() {
        CenterIcon.setImage(R.drawable.icon_destination);
